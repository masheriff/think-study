...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_hero_type" AS ENUM('none', 'superHighImpact', 'highImpact', 'mediumImpact', 'lowImpact');
  ...
  CREATE TYPE "public"."enum__pages_v_version_hero_type" AS ENUM('none', 'superHighImpact', 'highImpact', 'mediumImpact', 'lowImpact');
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v" (
  	...
  	"version_hero_bottom_rich_text" jsonb,
