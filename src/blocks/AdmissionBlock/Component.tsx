    ...
    return (
        <section className={cn('py-10   md:px-12', className, textStyles)}>
            <div className=" max-w-6xl p-6 py-4 mx-auto relative flex flex-col bg-[#D9F1FD] rounded-3xl md:flex-row items-start md:items-center">
                ...
                {/* Right Content */}
                <div className="md:w-2/3 px-6 ps-[50px] md:ps-[160px]">
                    <p className="text-xl text-[#ff0000] italic mb-0 italic font-Delius" >{ambitions}</p>
                    <p className="text-lg font-normal max-w-[430px]">{successRate}</p>
                    ...
                    {/* Courses */}
                    <div className="mt-6">
                        <div className="flex items-center gap-3 ms-[-46px] md:ms-[-46px]">
                            <div className="flex items-center gap-2 flex-col me-[10px]">
                                <div className="text-[25px] font-medium mb-[-10px]">We excel in</div>
                                <div className="text-[10px] mt-0">(UG & PG)</div>
                            </div>

                            {/* <span className="text-6xl font-bold">{`{`}</span> */}
                            <div className='absolute ms-[170px]'>
                                {rightImage?.url && (
                                    <Image
                                        src={CurlBraces}
                                        alt="CurlBraces"
