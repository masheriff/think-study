...
export const StudyInInsights: React.FC<Props> = ({
    ...
    return (
        <section className={cn('container px-6 sm:px-0 md:px-0', className)} aria-labelledby="study-notes-title">
            <div className="bg-[#D9F1FD] rounded-3xl flex flex-col items-center justify-between md:flex-row p-4 sm:p-6 md:p-16 lg:p-16 gap-4 md:gap-8 overflow-hidden">
